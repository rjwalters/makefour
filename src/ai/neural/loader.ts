...
const MODEL_REGISTRY: ModelMetadata[] = [
  ...
  // Oracle-trained models (curriculum learning from minimax)
  {
    id: 'oracle-v2',
    name: 'Spark MLP',
    architecture: 'mlp',
  ...
  },
  {
    ...
    expectedElo: 1400,
    sizeBytes: 2643517,
    url: '/api/models/cnn-oracle-v1/data',
    version: '1.0.1',
    encoding: 'onehot-6x7x3',
  },
  {
    ...
    expectedElo: 1650,
    sizeBytes: 12846179,
    url: '/api/models/resnet-oracle-v1/data',
    version: '1.0.0',
    encoding: 'onehot-6x7x3',
  },
  // Legacy self-play models
  {
    id: 'selfplay-v1',
    name: 'Self-Play v1',
    architecture: 'mlp',
